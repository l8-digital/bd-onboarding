...
export const Input = forwardRef<HTMLInputElement, InputLabelTextTypes>((props, ref) => {
    const {
        label,
        value = '',
        disabled = false,
        floating = true, // padrão: label flutuante
        id,
        setState,
        required,
        type = 'text',
    ...
    const getMaskedValue = (val: any) => {
        ...
        if (maskType === 'phone') return formatPhone(val);
